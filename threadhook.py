...
def sendMessage(msg_link, msg_text, msg_image, msg_video, author_name, icon_url, webhook_url, timestamp=None):
    max_retries = 5
    retry_delay = 2
        ...
        try:
            ...
            for tg_box in scrapeTelegramMessageBox(tg_channel):
                ...
                if last_processed_number > 0 and current_number > last_processed_number + 1:
                    sendMissingMessages(tg_channel, last_processed_number, current_number, author_name, icon_url, webhook_url, timestamp)
                ...
                if msg_link not in msg_log:
                    ...
                    sendMessage(msg_link, msg_text, msg_image, msg_video, author_name, icon_url, webhook_url, timestamp=timestamp)
