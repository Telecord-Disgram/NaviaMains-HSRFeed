...
MTPROTO_TEST_CONFIGURATION_IP_ADDRESS = os.getenv("MTPROTO_TEST_CONFIGURATION_IP_ADDRESS")
MTPROTO_PRODUCTION_CONFIGURATION_IP_ADDRESS = os.getenv("MTPROTO_PRODUCTION_CONFIGURATION_IP_ADDRESS")